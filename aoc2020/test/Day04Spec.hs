  ...
  describe "all" $ do
    it "all" $ do
      Mega.parse
        ...
        "a"
        "ecl:gry pid:1\neyr:2020\n\niyr:2013 ecl:#aaa pid:1f4323"
        `shouldBe` Right
          [ [Field EyeColor "gry", Field PassportID "1", Field ExpirationYear "2020"],
            [Field IssueYear "2013", Field EyeColor "#aaa", Field PassportID "1f4323"]
          ]
      is #_Right (Mega.parse (Common.parse solution) "a" example1) `shouldBe` True
